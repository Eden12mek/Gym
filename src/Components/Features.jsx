  ...
  return (
    <div id="features" className="text-white px-4 lg:px-10 mb-20">
      ...
      <div className="flex flex-wrap pt-8 max-w-full mt-20">
        {/* Feature 1 */}
        <div className="flex flex-col items-center basis-full sm:basis-1/2 lg:basis-1/4 p-6 rounded-lg shadow-xl border-2 border-transparent transition-transform transform hover:scale-105 hover:shadow-[0_0_20px_red] hover:border-red-600">
        ...
        {/* Feature 4 */}
        <div className="flex flex-col items-center basis-full sm:basis-1/2 lg:basis-1/4 p-6 rounded-lg shadow-xl border-4 border-transparent transition-transform transform hover:scale-105 hover:shadow-[0_0_20px_red] hover:border-red-600">
